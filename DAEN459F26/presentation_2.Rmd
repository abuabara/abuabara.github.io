...
.box-inv-1.medium.sp-after-veryshort[**Today**: questions?, design]
.box-inv-1.medium.sp-after-veryshort[**Friday**: teams, responsibilities, projects]
.box-inv-1.medium.sp-after-veryshort[**Next week**: sponsor engagement, stakeholder analysis, effective interviewing]
...
* .small[The scientific process emphasizes <u>explanation</u>, <u>prediction</u>, and <u>discovery</u>.]
* .small[The engineering process focuses on <u><span style="color: red;">application of systematic thinking</span></u> to leverage technology in service of <u><span class="highlight" style="color: red;">human needs</span></u>!]
...
1. <u>Define</u> the problem (*Why make a pencil?*)
2. <u>Research</u> & <u>brainstorm</u> (*What materials & designs?*)
3. <u>Develop</u> concepts (*Sketch ideas, pick the best*)
4. <u>Build</u> & prototype (*Make a sample pencil*)
5. <u>Test</u> & <u>evaluate</u> (*Does it write? Break?*)
6. <u>Redesign/refine</u> (*Improve core, casing, process*)
...
.pequeno[
- **Identify the problem** – Define the need, challenge, or design goal.
- **Establish criteria and constraints** – Determine requirements, limitations, cost, safety, and performance expectations.
- **Research and analyze** – Gather relevant scientific, mathematical, and technical information.
- **Generate possible solutions** – Brainstorm and compare multiple design approaches.
- **Develop a prototype or model** – Build, simulate, or represent a proposed solution.
- **Test and evaluate** – Measure how well the design satisfies the criteria.
- **Iterate and improve** – Use test results and feedback to refine the design.
- **Communicate the solution** – Document and present the design process, decisions, and results.
- **Connect disciplines** – Integrate mathematics, science, technology, computing, and engineering concepts.
]
