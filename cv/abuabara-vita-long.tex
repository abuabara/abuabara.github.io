...
\begin{enumerate}[leftmargin=40pt]
\item Ramtin et al (Spring 2026)
      - \emph{1st place in major of the 2026 COE Project Showcase}
\item Alexander et al (Spring 2026)
\item Lance et al (Spring 2026)
\item Jan Barrett, Eric Gomez, Annemarie Hoffzimmer, Thomas Lim, Isha Pokerna, Gabrielle Wibner.
      Pedestrian Conflict at Railroad Crossings. Sponsor: Cyndi Lee, Program Aide for the East End District, Houston, TX. (Fall 2025)
      - \emph{3rd place in major of the 2025 COE Project Showcase}
\end{enumerate}
