...
%-----------------------------------------------
\begin{frame}{}
\begin{block}{When flipping a fair coin, we say\\
"\it{the probability of flipping Heads is 0.5.}"}
How do you interpret this probability?
\begin{itemize}
    \item If I flip this coin over and over, roughly 50\% will be Heads.
    \item Heads and Tails are equally plausible.
    \item Both a and b make sense.
\end{itemize}
\end{block}
\end{frame}
