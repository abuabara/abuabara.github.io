...
\[
P(B)=0.40 \quad \rightarrow \quad P(B^c)=0.60
\]
...
\begin{itemize}
    ...
    \item \emph{Example}: rolling a die and flipping a coin are independent, because the die result does not affect the coin flip.
\end{itemize}
\end{block}
\end{frame}
