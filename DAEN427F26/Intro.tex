...
The course:
\begin{itemize}
    \item \textbf{Introduces core Bayesian statistical methods} used in data science and engineering research;
    \item \textbf{Emphasizes understanding}, data-driven decision-making, clear communication of results, and critical evaluation of evidence;
    \item \textbf{Draws on relevant examples} from engineering, psychology, economics, and public health policy; and
    \item \textbf{Uses modern software} to reproducibly analyze and interpret data in support of sound scientific conclusions.
\end{itemize}
\end{block}
\end{frame}
...
\begin{itemize}
    \item \textbf{To be a great teacher} ... that means always learning, adapting, and getting better each and every day.
    \item \textbf{That you learn} concepts, analyze data, pass the class!
\end{itemize}
\end{block}
\centering
...
\begin{itemize}
    ...
    \item The real goal is \textbf{to learn how to ASK questions}.
    \item[] \qquad \qquad \qquad \includegraphics[height=4cm]{Meme-face-thumbs-up.png}
