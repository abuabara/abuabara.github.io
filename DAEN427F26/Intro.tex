...
\begin{itemize}
    \item \textcolor{aggiemaroon}{\textbf{To be a great teacher} ... that means always learning, adapting, and getting better each and every day.}
    \item \textbf{That you \ul{learn}} concepts, analyze data, pass the class!
\end{itemize}
\end{block}
\centering
