...
% -------------------------------------------------
\begin{document}
\title{\color{aggiemaroon}{\textbf{DAEN 427 / ISEN 427 Decision and Risk Analysis}\\[-4pt]
{\normalsize Fall 2026}}}
...
\item[Cross listing] ISEN 427 / DAEN 427
...
\hline
Exam (2)                        & 60\% (30\% each)   & Content on weeks 1--6 \& 1--12 \\
Project (report + presentation) & 28\% (groups of 2) & Case study exploring decision and risk analysis in engineering \\
Participation                   & 12\%               & In-class (quizzes, discussions, assignments, practice questions) \\
\hline
\end{tabular}
...
6  & Bayesian workflow and model validation & Ch. 8 \\ \hline
   & \textbf{Exam 1: Bayesian foundations + computation} & \\ \hline
...
12 & Hierarchical Bayesian models & Ch. 15--16 \\ \hline
   & \textbf{Exam 2: Predictive modeling + risk analysis} & \\ \hline
...
14 & Bayesian decision analysis and probabilistic forecasting & Ch. 19 \\ \hline
   & \textbf{Final project: probabilistic programming, risk communication} & \\ \hline
\end{tabular}
...
\item E-mail is the primary method of communication. Include the course number in the subject line.
