...
--
.box-6.sp-after-short[<span style="color: yellow;">Ethical Conduct</span>]
...
.center[
<figure>
<img src="images/TAMU-Industrial-and-Systems-Enginnering.png" alt="ISEN TAMU logo" title="ISEN TAMU" width="47%">
</figure>
]
...
background-image: url("images/double-diamond-design-thinking.png")
...
.box-inv-4.SMALL.sp-after-short[
...
.center[
<figure>
<img src="images/today.jpg" alt="Today calendar" title="Today!" width="17%">
</figure>
]
...
.center[
<figure>
<img src="images/SpringBreak3.png" alt="Spring Break" title="Spring Break" width="60%">
</figure>
]
...
.box-inv-4.sp-after-short[Phase Kickoff Weeks]

* Entire team <span style="color: red;">must be present</span>
* Details on phase
  * Content
...
.box-inv-4.sp-after-short[Presentation Weeks]

* On the day for your group, ALL team members must be present, the entire time!
  * Appropriate attire
  * Be a good listener
  * <span style="color: red;">Ask</span> questions, participate!
* You are welcomed/<span style="color: red;">encouraged</span> to attend presentations on the day of the other group
...
.box-inv-4.SMALL.sp-after-short[<span style="color: red;">ALL team members</span> should attend sponsor meetings;<br>absences must be acknowledged with reasons]
...
.center[
<figure>
<img src="images/important-2.png" alt="Important" title="Important" width="20%">
</figure>
]
...
| Final Report            | 18%           | "          |
|                    |        |       |
| <span style="color: #C13835;">**Individual Grades**</span>   | &nbsp;        | &nbsp;     |
...
* <span style="color: #3a1a1a; font-size: 22pt;">Code of Conduct: will not be graded but MUST be turned in as a group assignment!</span>
  * <span style="color: #3a1a1a; font-size: 22pt;">As well other things in the deliverables table: Showcase Registration, Meeting Logs, etc.</span>

* <span style="color: #3a1a1a; font-size: 22pt;">Next week I'll give more details on the Engineering Project Showcase, Phase Presentations, etc.</span>
.center[
<figure>
<img src="images/stay-tuned.png" alt="stay tuned" title="stay tuned" width="30%">
</figure>
]
...
* <span style="color: #3a1a1a; font-size: 22pt;">Check Canvas for all due dates</span>
  * <span style="color: #3a1a1a; font-size: 22pt;">They’re final unless we send a notice by Canvas + email</span>
* <span style="color: #3a1a1a; font-size: 22pt;">You can resubmit assignments for a better grade after the due date</span>
* <span style="color: #3a1a1a; font-size: 22pt;">All regrade work must be in by the assignment’s close date</span>
--

* <span style="color: #3a1a1a; font-size: 22pt;">When resubmitting, make sure to:</span>
  * <span style="color: #3a1a1a; font-size: 22pt;"><span class="highlight">Highlight</span> what you changed</span>
  * <span style="color: #3a1a1a; font-size: 22pt;">Address ALL feedback from class, presentations, or office hours</span>
...
.center[
<figure>
<img src="images/ProjectCharterIntegration.png" alt="Project Charter Integration" title="Project Charter Integration" width="80%">
</figure>
]
...
.center[
<figure>
<img src="images/SystemsEngineeringVeeEdited.png" alt="vee-model" title="vee-model" width="70%">
</figure>
]
...
<span style="color: purple; font-size: 34pt;">
<b>Check out ...</b>
</span>
