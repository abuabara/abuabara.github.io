...
\hline
\textbf{Week} & \textbf{Topics} & \textbf{Reading} & \textbf{Lab/Coding} \\
\hline

1 &
Python and Jupyter: functions, debugging, profiling. &
\textit{PDSH} Ch.1, \textit{RBR} Ch.1 &
Load / explore a dataset in Jupyter. \\
\hline
...
4 &
Data transformation: grouping, pivot tables, strings, time series. &
\textit{PDSH} Ch.3 &
Summarize and transform data. \\
\hline

5 &
Recursion: recursive and iterative solutions, base cases, call stacks. &
\textit{RBR} Chs.1--2 &
Compare recursive and iterative programs. \\
\hline

6 &
Algorithms: binary search, merge sort, quicksort, efficiency. &
\textit{RBR} Chs.3+5 &
...
\textit{PDSH} Ch.4 &
Mini-Project: Explore and visualize a real dataset. \\
\hline

8 &
(Scikit-Learn) Machine learning basics: training, testing, and evaluation. &
\textit{PDSH} Ch.5 &
...
\textit{PDSH} Ch.5, \textit{RBR} Ch.4 &
Build tree-based models. \\
\hline

12 &
Clustering, PCA, and model selection. &
\textit{PDSH} Ch.5 &
Apply clustering, dimensionality reduction. \\
\hline

13 &
Optimization: backtracking, memoization, dynamic programming. &
\textit{RBR} Chs.6--8 &
Solve and improve an optimization problem. \\
\hline

14 &
(Final project) Data preparation, machine learning, optimization. &
Review &
