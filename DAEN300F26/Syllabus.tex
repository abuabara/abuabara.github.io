...
\item Use Python and Jupyter to solve data engineering problems.
\item Clean, transform, and analyze data using NumPy and pandas.
\item Apply basic algorithms, including recursion, searching, and sorting.
\item Build and evaluate basic machine learning models.
\item Use optimization techniques to improve computational solutions.
\item Create and explain an end-to-end data analysis and machine learning workflow.
\end{enumerate}
